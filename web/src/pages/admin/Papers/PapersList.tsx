  ...
  return (
    <div className="p-4 sm:p-8 space-y-8 animate-fade-in">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <button
          onClick={() => navigate("/question-paper/new")}
          className="inline-flex items-center gap-2 bg-primary text-primary-foreground rounded-full font-bold px-6 py-3 hover:opacity-90 hover:-translate-y-0.5 transition-all"
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center py-20 text-center">
          <svg width="120" height="120" viewBox="0 0 120 120" fill="none" className="mb-6 opacity-30">
            <rect x="20" y="10" width="80" height="100" rx="8" fill="hsl(var(--primary))" />
          ...
          <button
            onClick={() => navigate("/question-paper/new")}
            className="mt-6 inline-flex items-center gap-2 bg-primary text-white rounded-full font-bold px-8 py-4 hover:opacity-90 hover:-translate-y-1 transition-all shadow-[0_8px_32px_rgba(252,128,25,0.15)]"
          >
            <Plus className="w-5 h-5" /> Create New Paper
          </button>
        </div>
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                    ...
                    <div className="flex flex-col items-end gap-3">
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          onClick={e => { e.stopPropagation(); navigate(`/question-paper/${paper.id}`); }}
